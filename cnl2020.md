...
<!--
You can register via the [SEMANTiCS registration system](https://2021-eu.semantics.cc/prices). The "CNL only" option costs €200, plus €42 taxes. (If you cannot afford this, contact us and we will see what we can do for you.)
-->
...
This is the tentative list of keynote speakers:
